variable batch_group {
    description = "all batch job vars definition"
    type = object ({
...
variable batch_container { 
    description = "all batch job container vars"
    type = object({
      name = optional(string, "serverless-hosted-runner-container")
      image = string 
      image_ver = string
      batch_service_account_email = string
      cloud_scheduler_service_account_email = string
